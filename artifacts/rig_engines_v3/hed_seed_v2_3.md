...
## Frame 1: Defense procurement primary
...
## Frame 2: Developer platform economics
...
## Frame 3: Electrification & connected powertrain
...
Most firms approach AI in industrial controls as a Copilot bolt-on or AI Center of Excellence pilot. **We reject that orthodoxy.** From first principles, the question is not "how do we add AI to controllers" but "what is the operating system for the next decade of mobile equipment?" That is the actual category.
